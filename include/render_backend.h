 ...
 *
 * EagleOS currently draws directly to VGA memory,
 ...
 *
 * Used by the EXEC native host API.
 */
 ...
 * Window coordinate transformation.
 *
 * Used by applications when drawing their own content
 * inside an EXEC-managed window.
 */
...
/*
 * Desktop/interface chrome helpers.
 */
